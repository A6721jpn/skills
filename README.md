...
| [rams-gui-design](./rams-gui-design) | ディーター・ラムス／ブラウンに通じる、抑制された機能主義的なGUIを設計・実装・リファクタリング・監査します。 | ラムス風、ブラウン風、工業的、時代に左右されない、ミニマルなGUIを求めるときに使用します。GUIであるだけでは自動適用しません。 |
