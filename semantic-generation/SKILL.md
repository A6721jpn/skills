...
description: |
  ...
  推論順序の要約）を書く前に使う。Triggers: 設計資料を書く、設計文書作成、
  調査報告を書く、対策案を書く、命名する、状態名・条件名・型名・メソッド名を決める、
  推論順序を要約する、referent table、対応表。Do not use for ユーザー原文の引用、
  単純な機械編集、既存名の再利用、定型出力、雑談、確立した用語だけで書ける短文。
---
